...
% this is a modified version of 'genLayoutDecomposedTree.m'
% main difference:
% layout generated by this version is more visually comfortable,
% the directed binary tree is more balanced

% current support plotting of 'time series'

function anchorTree = genLayoutDecomposedTree2(decomposedTree, reference)
    narginchk(1,2);
    ...
    [maxSiblings, plot_cutoff] = max(cntSiblings);
...
%         xMargin = (spanX - len - (nSiblings-1)*gapX)/2;
    ...
    %% (2) from plot_cutoff to bottom
	for i=plot_cutoff:depth-1
