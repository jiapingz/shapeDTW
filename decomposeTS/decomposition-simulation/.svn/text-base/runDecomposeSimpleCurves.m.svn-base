...
%% (2) decompse simulated simple curves
    saveDir = '/lab/ilab/30/jiaping-iccv/curve-simulations/decomposedTS/simulations-50-simple-noise';
    simulatedcurvesDir = '/lab/ilab/30/jiaping-iccv/curve-simulations/data/simulations-50-simple-noise';
